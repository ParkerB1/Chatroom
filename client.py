...
class Send(threading.Thread):
    ...
    def run(self):
        ...
        #listens for user input from the command line and sends it to the server
...
def main(host, port):
    ...
    #initialize and run the chatroom
    ...
    textInput.bind("<Return>", lambda x: client.exit(textInput))
    textInput.insert(0, "Your message goes here")
